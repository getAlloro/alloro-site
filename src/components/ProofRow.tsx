...
const ProofTile: React.FC<ProofTileProps> = ({ value, label, source, updated, isPositive = true }) => (
  <div className="group bg-white rounded-2xl border border-slate-100 shadow-soft p-6 flex flex-col items-start hover:border-alloro-200 hover:shadow-lg transition-all duration-300 w-full">
    ...
    <div className="w-full pt-4 border-t border-slate-50 flex items-center justify-between text-xs text-slate-400 group-hover:text-slate-500 transition-colors">
